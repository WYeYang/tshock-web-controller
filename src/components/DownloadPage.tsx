        ...
        <div className="bg-slate-900 rounded-2xl p-8 mb-8 border border-slate-800">
          ...
          <div className="flex flex-col items-center gap-4">
            <a
              ...
              className="group inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-400 hover:to-purple-500 rounded-xl font-semibold text-lg transition-all transform hover:scale-105 shadow-lg shadow-cyan-500/20"
            >
            ...
            <p className="text-slate-500 text-sm">
              或访问 <a href="https://github.com/WYeYang/tshock-web-controller/releases/latest" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:text-cyan-300 underline">GitHub Releases</a>
            </p>
          </div>
        </div>
        ...
        <div className="bg-slate-900 rounded-2xl p-8 mb-8 border border-slate-800">
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-8 h-8 bg-cyan-500 rounded-full flex items-center justify-center text-sm font-bold">1</div>
              <div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-400">双击运行应用程序</p>
              </div>
            </div>
            <div className="flex gap-4">
